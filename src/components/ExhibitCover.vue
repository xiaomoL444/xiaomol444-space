...
<template>
  <div class="exhibit-cover">
    <img v-if="src && !failed" :src="src" :alt="name" loading="lazy" decoding="async" referrerpolicy="no-referrer" @error="failed = true" />
...
.exhibit-cover > img { display: block; width: 100%; height: 100%; object-fit: cover; transition: transform 400ms ease; }
